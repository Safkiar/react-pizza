    ...
    <div className="py-6 px-4">
      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            required />
               {addressStatus === 'error' && ( <p
          className="text-xs mt-2 text-red-700 bg-red-100 p-2 rounded-md">
            {errorAddress}</p>)}
          </div>
       {!position.latitude && !position.longitude && (   <span className="top-[3px] absolute right-[5px] z-50 md:right-[5px] md:top-[5px]">
      ...
      >get position</Button>
        ...
        <div>
          ...
          <input type='hidden' name='position' value={ position.longitde && position.latitude ? `${position.latitude},${position.longitude}` : ''} />
...
export async function action({ request }) {
  ...
  const errors = {};
  if (!isValidPhone(order.phone)) errors.phone = "Please insert a numbers";
